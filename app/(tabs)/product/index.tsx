...
import { ADD_TO_CART, SHOW_ORDER } from "@/src/api/mutation/order";
import styles from "@/components/styles/ProductStyles";
...
export default function ProductScreen() {
  const { products, selectedIndex, productVariantId, price, categoryID } = useLocalSearchParams();
  const selectedProducts = JSON.parse(products)[Number(selectedIndex)];
